...
public class CustomActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.aty_notify_custom);
		initView();
		initButtonReceiver();
	}
...
//		view_notify_custom.setLong(R.id.tv_custom_time,"setTime", System.currentTimeMillis());//不知道为啥会报错，过会看看日志
		//设置number
...
//		notify.contentView = view_notify_custom;
